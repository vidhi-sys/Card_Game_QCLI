🧙‍♀️ Enchanted Disney Witch Memory Game
A magical memory matching game built by vidhi-sys with the assistance of Amazon Q CLI, using the Python programming language and the Pygame library. The game features a beautiful Disney-style aesthetic and runs on Ubuntu via WSL.

✨ Features
Animated Background: A dynamic night sky with a subtle moving pattern, a moon with a glowing effect, and a Tangled-style castle with animated windows and flags.
...
git clone https://github.com/vidhi-sys/Card_Game_QCLI.git
cd Card_Game_QCLI
